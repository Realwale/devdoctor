...
@Command(name = "devdoctor", description = "Evidence-based root-cause diagnostics for software failures.",
        mixinStandardHelpOptions = true, version = "DevDoctor 0.2.0",
        subcommands = {DiagnoseCommand.class, RunCommand.class, InspectCommand.class, EvidenceCommand.class, HypothesisCommand.class, BenchmarkCommand.class, VersionCommand.class})
